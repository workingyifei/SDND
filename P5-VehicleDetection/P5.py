...
def train():
    ...
    cars_images = glob.glob('./vehicles_smallset/cars*/*.jpeg')
    notcars_images = glob.glob('./non-vehicles_smallset/notcars*/*.jpeg')
    cars = []
    notcars = []
    ...
    x_start_stop = [300, None] # Min and max in y to search in slide_window()
...
def process(image):
    ...
    windows = slide_window(image, x_start_stop=x_start_stop, y_start_stop=y_start_stop, 
                        xy_window=(105, 105), xy_overlap=(0.6, 0.6))
